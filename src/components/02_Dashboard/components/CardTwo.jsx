    ...
    <>
      <div className=" flex w-full dark:bg-white">
        <div className="flex-col">
          ...
          <p className="text-sm my-4">Citando la norma Peruana E.030 de Diseño sismoresistente en su 
          ...
          <p className="text-red-500  font-bold text-sm my-2">Para este proyecto se centro en el sistema aporticado, sin embargo, se dejó la interfaz avanzada para futuras implementaciones de otros sistemas. </p>
          <div className="grid grid-cols-3  gap-6">
            ...
            <CardPlus title="S - Dual" enlace="/dashboard/metrado" />
            <CardPlus title="S - (EMDL)" enlace="/dashboard/metrado" />
          </div>
        </div>
        <div>
