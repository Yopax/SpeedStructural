      ...
      <div className="w-full text-center items-center p-2 grid grid-cols-1 max-[1024px]:grid-cols-3 max-[768px]:grid-cols-2 max-[425px]:grid-cols-1 justify-center mt-8 mb-8 ">
        ...
        <div className="flex flex-col text-white items-center justify-center  font-bold m-2 rounded-md h-[380px] bg-emerald-600">
          <div>
            ...
            <p className="text-justify mb4:w-[500px] mb1:w-[200px] mb4:text-sm mb1:text-xs font-normal my-6 text-white"> 1. COLUMNAS CENTRADAS</p>
            <p className="text-justify mb4:w-[500px] mb1:w-[200px] mb4:text-sm mb1:text-xs font-normal my-6 text-white">rea de columna = P (servicio) / 0,45f‘c</p>
            <p className="text-justify mb4:w-[500px] mb1:w-[200px] mb4:text-sm mb1:text-xs font-normal my-6 text-white"> 2. COLUMNAS EXCENTRICAS Y ESQUINADAS</p>
            <p className="text-justify mb4:w-[500px] mb1:w-[200px] mb4:text-sm mb1:text-xs font-normal my-6 text-white">Área de columna = P (servicio) / 0,35f’c <br /></p>
          </div>
        </div>
