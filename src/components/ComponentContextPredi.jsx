...
const claseOne = "text-xs text-white  mx-2";
function ComponentContext2() {
  ...
  return (
    <div className="flex flex-col items-center bg-emerald-600">
        ...
        <input className={commonInputClasses} placeholder="cm" value={inputValue7} onChange={(e) => updateInputValue7(e.target.value)}/>
        <label className={claseOne}>Ln - Viga x-x:</label>
        <input className={commonInputClasses} placeholder="cm" value={inputValue8} onChange={(e) => updateInputValue8(e.target.value)}/>
        <label className={claseOne}>Ln - Viga y-y:</label>
        <input className={commonInputClasses} placeholder="cm" value={inputValue9} onChange={(e) => updateInputValue9(e.target.value)}/>
        <label className={claseOne}>AT - Columna centrada:</label>
        <input className={commonInputClasses} placeholder="m2" value={inputValue10} onChange={(e) => updateInputValue10(e.target.value)}/>
        <label className={claseOne}>AT - Columna esquinada:</label>
        <input className={commonInputClasses} placeholder="m2" value={inputValue11} onChange={(e) => updateInputValue11(e.target.value)}/> 
        <label className={claseOne}>AT - Columna exentrica:</label>
        <input className={commonInputClasses} placeholder="m2" value={inputValue12} onChange={(e) => updateInputValue12(e.target.value)}/>
